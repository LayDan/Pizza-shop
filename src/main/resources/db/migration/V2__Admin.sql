...
insert into user_profile (id,active, bonus ,first_name,last_name,password,username) values (2,1,0,'a','a','$2a$08$giBOFT9QDoGaFdag43Mgf.HSWCSoS5WRXxTjLLi0glMnqNUnaCUFS', 'u');
