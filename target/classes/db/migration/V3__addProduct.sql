insert into product (id, code ,name,description,type,image_path) values (1, 0001, 'Pizza Санмария' , 'Вкусная пицца', 'PIZZA','1.jpeg');
...
insert into product (id, code ,name,description,type,image_path) values (2, 0002, 'Pizza Франческо' , 'Бесподобная пицца', 'PIZZA','2.jpg');
